...
def post_data(req_url: str,json_payload: dict | None, headers: dict[str, str] = None) -> dict[str, dict|int|bool|str]:
    """
...
def get_data(req_url: str, params: dict[str, str], headers: dict[str, str] = None) -> dict[str, dict|int|bool|str]:
    """
